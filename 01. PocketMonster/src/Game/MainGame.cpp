...
HRESULT MainGame::init()
{
	...
	SOUNDMANAGER->addSound("PokemonGet", "Sounds/PokemonCatch.mp3", false);
	...
	SOUNDMANAGER->addSound("FireBlast", "Sounds/Fire_Blast.mp3", false);//불대문자
	SOUNDMANAGER->addSound("HydroPump", "Sounds/Hydro_Pump.mp3", false);//하이드로펌프
	SOUNDMANAGER->addSound("QuickAttack", "Sounds/Quick_Attack.mp3", false);//전광석화
	SOUNDMANAGER->addSound("RazorLeaf", "Sounds/Razor_Leaf.mp3", false);//잎날가르기
	SOUNDMANAGER->addSound("Tackle", "Sounds/Tackle.mp3", false);//몸통박치기
	SOUNDMANAGER->addSound("ThunderWave", "Sounds/Thunder_Wave.mp3", false);//전기자석파
	SOUNDMANAGER->addSound("Thunderbolt", "Sounds/Thunderbolt.mp3", false);//10만볼트
	SOUNDMANAGER->addSound("WingAttack", "Sounds/Wing_Attack.mp3", false);//날개치기
